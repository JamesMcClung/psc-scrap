...
# pfd
e_x = ParamMetadata("e_x", "$E_x$", None, None, "RdBu_r", "pfd", "ex_ec", skipFirst=True)
...
b_rho = ParamMetadata("b_rho", "$B_\\rho$", None, None, "RdBu_r", "pfd", ["hy_fc", "hz_fc"], combine="radial", skipFirst=True)
b_phi = ParamMetadata("b_phi", "$B_\\phi$", None, None, "RdBu_r", "pfd", ["hy_fc", "hz_fc"], combine="azimuthal", skipFirst=True)
b = ParamMetadata("b", "$|B|$", 0, None, "inferno", "pfd", ["hy_fc", "hz_fc"], combine="magnitude", skipFirst=True)
